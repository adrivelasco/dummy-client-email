...
export default () => {
  const theme = createMuiTheme({
    ...
    shadows: [
      'none',
      '0px 1px 3px 0px rgba(0, 0, 0, 0.1),0px 1px 1px 0px rgba(0, 0, 0, 0.05),0px 2px 1px -1px rgba(0, 0, 0, 0.04)',
      '0px 1px 5px 0px rgba(0, 0, 0, 0.1),0px 2px 2px 0px rgba(0, 0, 0, 0.05),0px 3px 1px -2px rgba(0, 0, 0, 0.04)',
      '0px 1px 8px 0px rgba(0, 0, 0, 0.1),0px 3px 4px 0px rgba(0, 0, 0, 0.05),0px 3px 3px -2px rgba(0, 0, 0, 0.04)',
      '0px 2px 4px -1px rgba(0, 0, 0, 0.1),0px 4px 5px 0px rgba(0, 0, 0, 0.05),0px 1px 10px 0px rgba(0, 0, 0, 0.04)',
      '0px 3px 5px -1px rgba(0, 0, 0, 0.1),0px 5px 8px 0px rgba(0, 0, 0, 0.05),0px 1px 14px 0px rgba(0, 0, 0, 0.04)',
